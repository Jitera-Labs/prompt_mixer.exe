...
export function AnchorForm({
  ...
  return (
    <div className="anchor-form flex flex-col h-full w-full overflow-hidden">
      <div className="flex gap-4 mb-4 shrink-0 items-start">
        ...
        <div className="nc-field">
          ...
          <input
            type="color"
            className="nc-input w-20 p-1 cursor-pointer"
            value={form.color}
      ...
      <div className="flex gap-4 mb-4 shrink-0 items-start">
        ...
        <div className="nc-field flex-1">
          <label className="anchor-form-label nc-label">LARGE ICON</label>
          <textarea
            className="nc-textarea font-mono resize-none"
      ...
      <div className="nc-field flex flex-col min-h-0 mb-4">
        <label className="anchor-form-label nc-label">PROMPT DEFINITION</label>
        <textarea
          className="nc-textarea flex-grow w-full resize-none custom-scrollbar"
      ...
      <div className="anchor-form-actions flex gap-4 shrink-0">
        ...
        <button
          onClick={onCancel}
          className="bg-transparent text-[var(--nc-white)] hover:bg-[var(--nc-white)] hover:text-black min-w-[100px]"
        >
          [CANCEL]
        </button>
      </div>
